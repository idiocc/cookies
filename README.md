...
- [`constructor(request: IncomingMessage, response: ServerResponse, options: CookiesOptions): Cookies`](#constructorrequest-incomingmessageresponse-serverresponseoptions-cookiesoptions-cookies)
  ...
  * [`_goa.CookieSetOptions`](#type-_goacookiesetoptions)
- [Copyright](#copyright)
...
Welcome, first time visitor! LastVisit=2019-05-06T04:05:15.989Z; path=/; httponly
LastVisit.sig=P3_TYNo77knAD1kWBVCJEm72S9o; path=/; httponly
Welcome back! Nothing much changed since your last visit at 2019-05-06T04:05:15.989Z.
```
...
| secure    | <em>boolean</em>                                                                                                                                         | Explicitally specifies if the connection is secure.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| __set*__  | <em>function(string, string=, <a href="#type-_goacookiesetoptions" title="Used to generate the outbound cookie header.">_goa.CookieSetOptions</a>=)</em> | This sets the given cookie in the response and returns the current context to allow chaining. If the value is omitted, an outbound header with an expired date is used to delete the cookie.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |

__<a name="type-_goacookiesetoptions">`_goa.CookieSetOptions`</a>__: Used to generate the outbound cookie header.
...
| domain    | <em>string</em>              | Indicats the domain of the cookie (no default).                                                                                                                                                                                                                                                                                                                | -       |
| secure    | <em>boolean</em>             | Indicats whether the cookie is only to be sent over HTTPS (false by default for HTTP, true by default for HTTPS).                                                                                                                                                                                                                                              | -       |
